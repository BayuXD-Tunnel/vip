...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/BayuXD-Tunnel/main/izin/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/BayuXD-Tunnel/main/izin/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/BayuXD-Tunnel/main/izin/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
print_install "Memasang Service Limit Quota"
wget raw.githubusercontent.com/BayuXD-Tunnel/vip/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
